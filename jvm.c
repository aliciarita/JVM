/**
 jvm.c
 *  Arquivo de implementacao das funcoes utilizadas pela JVM implementada
 */
...
/**
 *  função para inicializar a estrutura JVM
 */
JVM* InicializarJVM() {
	JVM *novo;
...
/**
 *  função que inicia a interpretacao do arquivo .class
 */
void executarJVM(){
...
/**
 *  função para atualizar o PC de acordo com a ultima instrucao  
 */
