/**
 * @file jvm.c
 * @brief Arquivo de implementacao das funcoes utilizadas pela JVM implementada
 */
...
/**
 * @brief Crai uma estrutura JVM vazia
 */
JVM* CriarJVM(){
	return NULL;
}
...
/**
 * @brief Funcao para inicializar a estrutura JVM
 */
JVM* InicializarJVM() {
	JVM *novo;
...
/**
 * @brief Funcao que inicia a interpretacao do arquivo .class
 */
void executarJVM(){
